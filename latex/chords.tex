...
\newcommand{\chord}[1] {$\stackrel{\makebox[0mm][l]{\hspace{1mm}\footnotesize{\textbf{#1}}}}{^{^{^{}}}}$}

% place a chord above and to the left of following letter
\newcommand{\chordleft}[1] {$\stackrel{\makebox[0mm][r]{\hspace{1mm}\footnotesize{\textbf{#1}}}}{^{^{^{}}}}$}
